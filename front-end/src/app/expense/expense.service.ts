...
export class ExpenseService {
  ...
  getExpenses(page = 1, limit = 10, search = '', sort = '', customSearch = {}): Observable<any[]> {
  ...
  updateExpenseSettled(data: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/settle`, data,{
      headers: this.getHeaders(),
    });
  }
}
